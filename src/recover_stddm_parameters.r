# recover_stddm_parameters.R - Code for recovering winning model parameters from "Negative affect influences the computations underlying food choice in bulimia nervosa" 
#
...
# 09/23/24      Blair Shevlin                         Updated attribute coding
...
for (gg in c("BN","HC")){
    for (cc in c("Neutral","Negative")) {
        ...
        save(results,
        Data_partial, file= paste0(recFolder,"/recover_HtSSM_FIT_M3_Dx-",gg,"_","Cond-",cc,"_rawRatings.RData"))   
    }
}
